...
title: "Assessing the Feasibility of a Cluster Randomised Trial on the Effect of Trauma Life Support Training: A Pilot Study"
...
Martin Gerdin Wärnberg (MGW) `r insert_orcid_link("0000-0001-6069-4794")`
...
##### Johanna Berg (JB) `r insert_orcid_link("0000-0001-7553-7337")`
...
##### Lovisa Strömmer (LS) `r insert_orcid_link("0000-0001-5424-7111")`
...
Systematic reviews call for controlled trials in settings where these programmes are not routinely implemented [@Jayaraman2014; @Kadhum2020], because conducting such effectiveness trials in settings where they are part of the standard of care would not be possible. Many settings without routinely implemented trauma life support training are in low- and middle income countries, where trial logistics can be challenging due to for example difficulties in patient follow up.
...
## Study Setting
We conducted this pilot study in seven Indian tertiary hospitals across metropolitan areas in India, where neither ATLS^®^, PTC, nor any other established trauma life support training program is routinely taught. 
...
The percentage of patients who consented to follow up was `r p.consent`% and the percentage of residents who consented to training was `r recruitment.rate.residents`%. Among patients, the lost to follow up rate was `r rate.lost.to.follow.up`%. Among residents, the pass rate was `r pass.rate`%. The missing data rate ranged from `r min.missing.data` to `r max.missing.data`%, with details for selected variables shown in Table \@ref(tab:sample-characteristics) and in Supplementary Table S1. The variables with the maximum amount of missing data were complications, reported in Supplementary Tables S1-12. The differences in distributions between observed data and data extracted from medical records, for selected variables that were collected through observation or interview, are shown in Table \@ref(tab:observed-vs-extracted). Overall, the data were similarly distributed, but there were considerably more missing values in extracted data compared to observed data.
