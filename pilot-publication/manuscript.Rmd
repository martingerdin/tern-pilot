...
After training, a total of `r m30d.standard.care` patients in the standard care arm died within 30 days, compared to `r m30d.atls` patients in the ATLS^®^ arm and `r m30d.ptc` patients in the PTC arm. The corresponding figures for in-hospital mortality were `r inhosp.standard.care`%, `r inhosp.atls`%, and `r inhosp.ptc`%. Absolute and relative changes from baseline, as well as absolute and relative risk differences, are shown in Table \@ref(tab:outcomes). Overall, mortality was lower in the ATLS^®^ and PTC arms compared to the standard care arm. The results for all other outcomes are shown in Supplementary Materials.
