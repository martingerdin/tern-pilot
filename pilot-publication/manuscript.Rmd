...
We found that the ATLS^®^ and PTC arms had lower 30-day mortality compared to the PTC and standard care arms. These findings hints towards a potential effect of training physicians in trauma life support, but it is important to note that this pilot study was not powered to detect any differences in outcomes. The arms differed considerably in sample size, with the ATLS^®^ arm having the smallest sample size. This difference most likely resulted from the randomisation process with a small number of heterogeneous clusters. This heterogeneity highlights the importance of taken different cluster sizes into account in the design of the full scale trial.
...
We conclude that a full-scale cluster randomised trial should be feasible after incorporating the lessons of this pilot.
