...
In the interest of space, only the 95% confidence intervals are presented for all comparisons as Supplementary Tables. The remaining results are available from the corresponding author on request.
