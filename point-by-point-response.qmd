...
The data collection period in each hospital was four months, but patients were followed up for one month. We have clarified this in the methods section.
...
We have added a table to the results section to report the number of patients included per month.
...
We now only report the yes in the outcomes tables.

> - The absolute difference versus relative difference does not add to the analyses and could be removed.

We have removed the absolute difference versus relative difference from the main results section, but kept it in the supplementary materials as it was part of the original protocol.
...
Thank you for this suggestion and we agree that a stepped wedge design would be a good approach for the full scale trial.
...
Yes, that is correct. Empty cells indicate that there were no observations. We have added a note to clarify this.